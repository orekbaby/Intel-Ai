...
const SocialMenu = () => {
  ...
  return (
    <div className="relative w-[193px] h-[40px] mb-5">
      <div className="w-full h-full flex justify-between items-center px-4 rounded-[10px] bg-[#1D1D1D] cursor-pointer" onClick={toggleDropdown}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-[#1D1D1D] shadow-md rounded-b-[10px] mt-1 z-10">
          <div
