...
const TweetCard: React.FC<CardProps> = ({ tweet, date, onDelete, time }) => {
  ...
  return (
    <div
      className="w-full max-w-[410px] h-auto pb-4 rounded-[20px] bg-[#252525] p-4 mx-auto cursor-pointer"
    ...
    >
      <div className="flex flex-col md:flex-row justify-between gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-1 w-full md:w-[60%] lg:w-[91px] justify-center items-center h-auto bg-[#131313] p-[3px] rounded-[12px]">
