...
const ProjectTraining: React.FC = () => {
  const { selectedName } = useSelectedName(); // Get selectedName from context
  const defaultTabValue = selectedName === "Openfi" ? "ApeTerminalTraining" : "LaunchPadTraining";
  return (
