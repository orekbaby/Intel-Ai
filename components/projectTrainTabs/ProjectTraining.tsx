        ...
        <div className="w-full px-0 md:px-6 lg:px-0 relative mb-0 md:mb-10 lg:mb-10 h-full overflow-x-hidden">
          <div className="pt-2">
            <Tabs
              ...
              className="w-full pt-0 md:pt-0 lg:pt-0 pl-0 md:pl-6 lg:pl-6"
            >
              <TabsList className="flex mt-0 mb-0 items-center justify-center md:justify-start lg:justify-start gap-4 md:gap-4 lg:gap-6 px-0 w-full">
                <TabsTrigger
                  className="w-fit h-[50px] md:w-fit lg:w-fit py-2 px-3 md:px-2 lg:px-2 data-[state=active]:text-white rounded-none data-[state=active]:border-b-2 border-white md:data-[state=active]:bg-transparent lg:data-[state=active]:bg-transparent text-[#4D4D4D] text-sm font-medium"
