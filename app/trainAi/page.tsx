...
const Page = () => {
  return (
    <>
      <div className="pl-2 md:pl-[290px] lg:pl-[290px] w-full h-[100vh] overflow-y-auto scrollbar-hide">
        <section className="relative w-full h-full mb-48 bg-[#131313]">
          <div className="w-full px-4 md:px-6 lg:px-10 relative mb-0 md:mb-10 lg:mb-10 h-full">
            <div className="pt-5">
              ...
              >
                <TabsList className="flex mt-0 mb-0 items-center justify-center md:justify-start lg:justify-start gap-2 md:gap-4 lg:gap-10 px-0 w-full border-b border-[#2B2B2B] pb-5">
  <TabsTrigger
