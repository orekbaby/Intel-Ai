...
<div
      ...
      leading-[30.28px] md:leading-[46.56px] lg:leading-[70.56px] text-center w-[378px] md:w-[90%] lg:w-[80%] xl:w-[70%] mb-5 mx-auto guaruja-font"
            ...
            <p className="font-normal text-sm md:text-[18px] lg:text-[22px] xl:text-[22px] text-[#8A8A8A] text-center mb-4 md:mb-6 lg:mb-8 px-4 md:px-8 lg:px-0 leading-[20px] md:leading-[26px] lg:leading-[28px] xl:leading-[30px]  mx-auto w-full md:w-full lg:w-[50%] xl:w-[45git add%]">
